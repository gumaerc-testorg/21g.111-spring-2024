---
content_type: page
description: This page provides information on student projects for the MIT course
  "Chinese Calligraphy," offered in Spring 2024 and taught by Kang Zhou.
draft: false
title: 'Projects for Chinese Calligraphy: A Project-Based Approach'
uid: ab119986-b011-409a-acb5-c4c5c4a585ef
---
The Chinese Calligraphy course at MIT is a project-based learning course that emphasizes practice, application, and reflection. Students engage in a variety of creative and research-driven projects throughout the semester. These projects allow students to explore calligraphy not only as a writing system but also as a form of cultural expression and interdisciplinary inquiry. 

Below are four representative projects selected from the course. Together, they demonstrate how students learn through doing, observing, researching, and creating.
...
This culminating project allows students to synthesize everything they’ve learned and practiced throughout the semester. Each student creates a complete, personal calligraphy piece, using kaishu (regular script) or xingshu (semi-cursive script) to demonstrate their foundational skills. 
...
1. Main text: The phrase or passage selected by the student
2. Inscription (落款): Written in the format “Time+Name書于+Location.” Students may add a personal seal if they have one.

### Evaluation Criteria:

1. Brush Technique: Control, consistency, strength, and variation in strokes 
2. Character Structure: Balance and clarity in the shape and proportion of characters 
3. Composition: Overall layout and use of space, including placement of the main text and inscription 
4. Content & Expression: Thoughtful selection of content and personal engagement with the work

On the final day of class, students present their finished work during an in-class exhibition. Each student briefly introduces their piece and discusses their process. The exhibition also serves as a celebration of the semester’s achievements.   
Student Submission Sample
...
1. Preface to the Poems Collected from the Orchid Pavilion by Wang Xizhi 
2. Draft of a Requiem to My Nephew by Yan Zhenqing 
3. Cold Food Observance by Su Dongpo 

Each group conducts detailed research through online sources and group discussions and presents their findings in class. Presentations address the following six guiding questions: 

1. Calligrapher's Background: Who was the calligrapher? What was their historical context and social role? 
2. Content of the Work: What does the piece say? Provide an English translation. 
3. Context and Emotion: Under what circumstances was the work written? What feelings or intentions are conveyed?
4. Significance: Why is this work considered a masterpiece? What is its greatest artistic or historical value? 
5. Formal Analysis: Analyze selected characters or lines, focusing on brush technique, rhythm, or variation. 
6. Personal and Group Reflection: Share your own thoughts and group impressions of the work. 
